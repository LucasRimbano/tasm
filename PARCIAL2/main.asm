...
cartel_menu db 0dh,0ah,"------------------------------",0dh,0ah
            db  " Bienvenido al segundo parcial..." ,0dh,0ah
             db "   MENU PRINCIPAL",0dh,0ah
             db "------------------------------",0dh,0ah
             db "1. Leer un texto (hasta 255 caracteres)...",0dh,0ah
             db "2. Cargar texto solo con letra...",0dh,0ah
             db "3. Contar y mostrar cantidad total de vocales...",0dh,0ah
             db "4. Imprimir el ultimo texto ingresado...",0dh,0ah
             db "5. Mostrar total de cargas de texto hechas...",0dh,0ah
             db "6. Salir...",0dh,0ah
             db "------------------------------",0dh,0ah
